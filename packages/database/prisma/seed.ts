...
async function main(): Promise<void> {
  ...
  await prisma.product.upsert({
    ...
    update: {
      ...
      brand: 'Sony',
      displayTitle: 'Sony Bravia 55 inch 4K Ultra HD Smart LED TV',
      normalizedTitle: 'sony bravia 55 inch 4k ultra hd smart led tv',
  ...
  const listings = [
    {
      ...
      normalizedTitle: 'sony bravia 139 cm 55 inches 4k ultra hd smart led google tv kd 55x74k',
      brand: 'Sony',
      modelNumber: 'KD-55X74K',
      ean: '0195949022029',
      ...
      reviewCount: 3421,
      mrpMinor: 9990000,
      startPriceMinor: 5799000,
      platformData: { salesRank: 42, browseNode: 'Electronics > TVs' },
      seed: 1001,
    },
    {
      ...
      url: 'https://www.flipkart.com/sony-bravia/p/itm6ac6485515ae4',
      title: 'SONY Bravia 139 cm (55 inch) Ultra HD (4K) LED Smart Google TV',
      normalizedTitle: 'sony bravia 139 cm 55 inch ultra hd 4k led smart google tv',
      brand: 'SONY',
      modelNumber: 'KD-55X74K',
      ean: '0195949022029',
